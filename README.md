...
### What's next
What I feel I could have added, was another decorator class that would inherit from MailTransferService, which the main job would be to catch errors and log them somewhere like ex: Datadog
